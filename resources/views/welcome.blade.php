    ...
    <div class="w-full max-h-full block card">
        ...
        <div class="text-center text-base md:text-2xl lg:text-3xl font-bold underline">Khasiat dan Manfaat Buah Markisa</div>
            <div class="max-w-lg text-justify">
                ...
                Mengkonsumsi buah Markisa, atau produk olahan dari buah Markisa berwarna kuning secara rutin dan teratur
    ...
    <div class="w-full max-h-full block mt-4 card ">
        <div class="flex justify-center ">
            <div class="max-w-xl card-body items-center text-center">
                <div class="text-base md:text-2xl lg:text-3xl  font-bold underline card-title">Cara Order Sari Markisa MegaBuana Makassar</div>
                <p class="text-base md:text-lg lg:text-2xl ">
                    Untuk memesan produk Sari Buah Markisa Karaeng 100% ASLI dari Makassar, silahkan hubungi Telp. 0822-9059-1298 setiap hari kerja.
                </p>
            </div>
        </div>
    </div>
