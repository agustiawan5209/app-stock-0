<x-guest-layout>
    ...
    <div class="w-full max-h-full block card">
        <div class="flex justify-center card-body items-center text-center ">
            <div class="text-center text-base md:text-2xl lg:text-3xl font-bold underline">Khasiat dan Manfaat Buah
                Markisa</div>
            <div class="max-w-lg text-justify">
                ...
                <ul type="1" class=" list-decimal pl-4">
                    <li>Mencegah Pertumbuhan Sel Kanker</li>
                    <li>Memperlancar dan Menyehatkan Pencernaan</li>
                    <li>Memiliki Efek Relaksasi</li>
                    <li> Baik untuk Penderita Insomnia</li>
                    <li> Baik untuk Penderita Asma</li>
                    <li>Sumber Nutrisi yang Baik</li>
                    <li>Mengoptimalkan Sistem Imunitas</li>
                    <li>Mengontrol Tekanan Darah</li>
                    <li>Baik untuk Diet</li>
                    <li> Baik dalam Memenuhi Gizi Tubuh</li>
                    <li>Baik untuk Kesehatan Mental dan Otak</li>
                    <li>Baik untuk Kesehatan Kulit</li>
                    <li>Mampu Mendorong Pertumbuhan Tulang dan Gigi</li>
    ...
    <div class="w-full max-h-full block mt-4 card ">
