<div>
    <div class="w-full md:mb-0">
        <form action="{{ route('Admin.Fermentasi-Create') }}" method="POST"
            class="flex md:flex-nowrap flex-wrap justify-center my-2 mx-4 md:mx-0">
            <div class="w-full max-w-xl bg-white rounded-lg shadow-md p-6">
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    ...
                    <div class="w-full md:w-full px-3 mb-6">
                        ...
                        <input
                            class="appearance-none block w-full bg-white text-gray-900 font-medium border border-gray-400 rounded-lg py-3 px-3 leading-tight focus:outline-none"
                            type='text' name='jumlah_stock' wire:model="jumlah_stock" required>
                    </div>
                    <div class="w-full md:w-full px-3 mb-6">
                        <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2"
                        ...
                        <input
                            class="appearance-none block w-full bg-white text-gray-900 font-medium border border-gray-400 rounded-lg py-3 px-3 leading-tight focus:outline-none"
                            type='date' name='tgl_frementasi' wire:model="tgl_frementasi" required>
                    </div>
